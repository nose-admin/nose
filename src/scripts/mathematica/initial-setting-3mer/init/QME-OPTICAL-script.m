...
(* PODIVNA KORELACNI FUNKCE!! *)

(*CCC[t_,\[CapitalLambda]\[CapitalLambda]_,\[Lambda]\[Lambda]_,\[Beta]_]:=0;
CC[t_,\[CapitalLambda]\[CapitalLambda]_,\[Lambda]\[Lambda]_,\[Beta]_]:=\[HBar] \[Lambda]\[Lambda] Coth[\[Beta] \[HBar] \[CapitalLambda]\[CapitalLambda]/2] \[CapitalLambda]\[CapitalLambda] E^(-\[CapitalLambda]\[CapitalLambda] Abs[t]);*) (*Coth[\[Beta] \[HBar] \[CapitalLambda]\[CapitalLambda]/2]*)
