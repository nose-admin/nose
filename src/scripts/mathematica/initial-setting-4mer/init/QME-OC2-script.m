...
(*Print["@@@2q",s," ",Re[Drop[res[s],-NN/2]],Im[Drop[res[s],-NN/2]]];*)
If[SECULAR,
Print["@@@2Q",s," ",Re[Drop[res[s],-NN/2]],Im[Drop[res[s],-NN/2]]],
Print["@@@2q",s," ",Re[Drop[res[s],-NN/2]],Im[Drop[res[s],-NN/2]]],
Print["@@@2q",s," ",Re[Drop[res[s],-NN/2]],Im[Drop[res[s],-NN/2]]]];
...
(*ListPlot[ Re[Drop[res[4],-3 NN/4]],PlotRange->All,Joined->True]*)
(*ListPlot[ Re[Drop[res[5],-3 NN/4]],PlotRange->All,Joined->True]*)
(*ListPlot[ Re[Drop[res[6],-3 NN/4]],PlotRange->All,Joined->True]*)
(*ListPlot[ Re[Drop[res[7],-3 NN/4]],PlotRange->All,Joined->True]*)
(*ListPlot[ Re[Drop[res[8],-3 NN/4]],PlotRange->All,Joined->True]*)
(*ListPlot[ Re[Drop[res[9],-3 NN/4]],PlotRange->All,Joined->True]*)
